 ...
 * $Id: Base64CoderOutputStream.java,v 1.2 2007/05/24 15:30:27 dwd Exp $
 *
...
class FrontierBase64CoderOutputStream extends java.io.FilterOutputStream
 {
  ...
  public FrontierBase64CoderOutputStream(OutputStream out)
   {
    super(out);
   }
    ...
    if(nsavedbytes>0)
     {
      ...
      noutbytes=FrontierBase64Coder.encode(savebytes,0,nsavedbytes,outbuf,noutbytes);
      nsavedbytes=0;
